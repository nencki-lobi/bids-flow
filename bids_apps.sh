...
#heudiconv
docker run --rm --user $(id -u):$(id -g) --network none -v /srv/mriqc/dicoms:/data:ro -v /home/bkossows/bids-flow/heuristic.py:/heuristic.py -v /srv/mriqc:/output nipy/heudiconv:0.5.4 --files /data/$1 -s $1 -f /heuristic.py -b --minmeta --overwrite -o /output
#mriqc
